...
int emd_forward_cuda(at::Tensor xyz1, at::Tensor xyz2, at::Tensor match, at::Tensor cost, at::Tensor temp) {
    ...
    approxmatch<<<32,512>>>(batch_size , n, m, xyz1.data<float>(), xyz2.data<float>(), match.data<float>(), temp.data<float>());
    ...
    matchcost<<<32,512>>>(batch_size, n, m, xyz1.data<float>(), xyz2.data<float>(), match.data<float>(), cost.data<float>());
    if (err != cudaSuccess) {
...
int emd_backward_cuda(at::Tensor xyz1, at::Tensor xyz2, at::Tensor gradxyz1, at::Tensor gradxyz2, at::Tensor match){
    ...
    const auto n = xyz1.size(1);
    const auto m = xyz2.size(1);
    matchcostgrad1<<<32,512>>>(batch_size, n, m, xyz1.data<float>(), xyz2.data<float>(), match.data<float>(), gradxyz1.data<float>());
    matchcostgrad2<<<dim3(32,32),256>>>(batch_size, n, m, xyz1.data<float>(), xyz2.data<float>(), match.data<float>(), gradxyz2.data<float>());
